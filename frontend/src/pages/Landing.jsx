        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10 mb-20">
            <div className="text-center p-10 bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-3xl border border-primary/10 dark:border-primary/20 hover:shadow-2xl hover:shadow-primary/10 dark:hover:shadow-primary/20 transition-all duration-300">
              ...
              <p className="text-primary dark:text-primary/90 font-semibold text-lg">+1 (555) 123-4567</p>
            </div>
            ...
            <div className="text-center p-10 bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-3xl border border-primary/10 dark:border-primary/20 hover:shadow-2xl hover:shadow-primary/10 dark:hover:shadow-primary/20 transition-all duration-300">
              ...
              <p className="text-primary dark:text-primary/90 font-semibold text-lg">hello@meditrack.com</p>
            </div>
            ...
            <div className="text-center p-10 bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-3xl border border-primary/10 dark:border-primary/20 hover:shadow-2xl hover:shadow-primary/10 dark:hover:shadow-primary/20 transition-all duration-300">
              ...
              <p className="text-slate-600 dark:text-slate-400 font-medium">123 Healthcare Ave, Medical District</p>
            </div>
          </div>
          
          <div className="max-w-3xl mx-auto">
            <div className="p-12 bg-gradient-to-br from-primary/5 via-white to-primary/10 dark:from-primary/10 dark:via-slate-800 dark:to-primary/20 rounded-3xl border border-primary/10 dark:border-primary/20 shadow-2xl">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <input 
                  type="text" 
                  placeholder="Your Name" 
                  className="w-full p-5 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:border-primary focus:outline-none transition-colors text-lg font-medium placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-800 dark:text-white"
                />
                <input 
                  type="email" 
              ...
              <textarea 
                ...
                className="w-full p-5 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:border-primary focus:outline-none transition-colors text-lg font-medium placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-800 dark:text-white mb-8 resize-none"
              />
              <button className="w-full py-5 bg-gradient-to-r from-primary to-primary/80 text-white font-bold text-xl rounded-xl hover:shadow-2xl hover:shadow-primary/25 transition-all transform hover:scale-105">
                Send Message
              </button>
            </div>
          </div>
